...
def topology():
    ...
    server = net.addDocker('server', ip='10.0.0.251', dimage="hooddxwd/server")
    client = net.addDocker('client', ip='10.0.0.252', dimage="hooddxwd/client")
    # d3 = net.addHost(
    ...
    info('*** Creating links\n')
    # net.addLink(h1, s1)
    net.addLink(s1, server, cls=TCLink,loss = 50)
    # net.addLink(h2, s2)
